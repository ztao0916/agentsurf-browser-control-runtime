...
const schemas = {
  ...
  'browser.get_interactives': { ...optionalTabId, ...frameId },
...
function descriptionFor(tool: ToolName): string {
  const descriptions: Record<ToolName, string> = {
    ...
    'browser.get_interactives': 'List interactive page elements and their opaque element_ids. Call this before any element action. Pass frame_id to inspect an iframe; the top document is frame 0, and an element_id only works in the frame that returned it.',
